...
class YEAR_CREDENTIAL:
    ...
    def __init__(self, top=None):
        ...
        self.Labelframe1.configure(text='''STUDENT CREDENTIAL PER YEAR''')
        self.Labelframe1.configure(background="#d9d9d9")
        self.Labelframe1.configure(width=470)

        self.BUTTON = Button(top)
        self.BUTTON.place(relx=0.37, rely=0.22, height=45, width=127)
        ...
        self.Button2.place(relx=0.37, rely=0.36, height=45, width=127)
        ...
        self.Button3.place(relx=0.37, rely=0.5, height=45, width=127)
        ...
        self.Button4.place(relx=0.37, rely=0.63, height=45, width=127)
